...
export const PhoneInput = forwardRef<HTMLInputElement, PhoneInputProps>(
  (
    ...
    const inputClasses = cn(
      "flex items-center gap-2 relative bg-transparent transition-colors text-base border-0 border-b-2 border-input pl-3 h-9 disabled:opacity-50 disabled:cursor-not-allowed md:text-sm has-[input:focus]:outline-none has-[input:focus]:ring-0 has-[input:focus]:border-b-2 has-[input:focus]:border-ring [interpolate-size:allow-keywords]",
